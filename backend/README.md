...
## Project Structure
    ...
    ├── testshareapp_dev_37840  # Django project configurations
...
1. Clone this repo and `cd testshareapp_dev_37840`
...
2. Clone this repo and `cd testshareapp_dev_37840`
